...
function SearchPageClient() {
  ...
  const filteredImages = images.filter((image) => {
    ...
    return (
      ...
      image.location_name?.toLowerCase().includes(normalizedQuery) ||
  ...
  useEffect(() => {
    ...
    filteredImages.forEach((image) => {
      ...
      if (measuredImagesRef.current.has(image.id)) return;
      ...
      probe.onload = () => {
        ...
        const shouldClip = Math.abs(aspectRatio - THREE_PANEL_ASPECT_RATIO) > THREE_PANEL_TOLERANCE;
          ...
          <div className="w-full max-w-[1960px] border-l border-r border-neutral-300 flex flex-col justify-start items-start gap-0">
            ...
            <div className="self-stretch flex flex-col justify-start items-start">
              {isInitialLoad ? (
                ...
                <div className="w-full flex flex-col justify-center items-center gap-2 py-12">
                  <p className="text-neutral-500 text-xs font-medium font-[var(--font-inconsolata)]">
                    ...
                    return (
                      ...
                      >
                        ...
                        {shouldClipToThreePanelMask ? (
                          <div className="relative w-full overflow-hidden" style={{ paddingBottom: THREE_PANEL_PADDING_PERCENT }}>
                            <img
                              className="absolute inset-0 w-full h-full"
                              src={thumbnailUrl}
                              srcSet={previewUrl ? `${thumbnailUrl} 400w, ${previewUrl} 1920w` : undefined}
